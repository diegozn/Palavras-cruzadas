...
function cruzadinha(){
    ...
    var palavra8 = (td_quad_q.value + td_quad_u.value + td_data_quad_a.value + td_quad_d.value + td_quad_c.value + td_rom_quad_o + td_quad_r.value + td_regis_quad_e.value).toUpperCase();
    ...
    var palavra11 = (td_massa_adres_a.value + td_adres_d.value + td_adres_r.value + td_dual_adres_e.value + td_adres_s_1.value + td_adres_s_2.value).toUpperCase();
    ...
    if(palavra8 == "DUALCORE"){
        msg.innerHTML += "Palavra 5: dualcore<br>"
    }else{
        console.log("erro na dualcore<br>")
    }
    ...
    if(palavra11 == "ADRESSBUS"){
        msg.innerHTML += "Palavra 14: adressbus<br>"
    }else{
        console.log("erro na adressbus")
    }
